...
def train(population_size, fraction_kept, generations, sub_generations, mutation_rate, threads=10):
    ...
    try:
        ...
        for thread_id in range(threads):
            thread = Thread(target=trainer_thread, args=(player_queue, thread_id, quit_event))
...
if __name__ == '__main__':
    ...
    best = train(population_size=100, fraction_kept=0.2, generations=10, sub_generations=10, mutation_rate=0.2,
                 threads=10)
    print("\n\nTraining Complete\n\n")
